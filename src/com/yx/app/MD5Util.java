...
public class MD5Util {    
    ...
    public static void main(String[] args) {    
        try {    
            ...
            String filePath = "C:/Users/YX/Desktop/装机还原.jpg";  
            String filePathSource="F:/装机还原.jpg";
            
            String sourceMd5Hashcode=md5HashCode(filePathSource);
            String sourceMd5Hashcode32=md5HashCode32(filePathSource);
            
            System.out.println(sourceMd5Hashcode + "：原文件的md5值");    
            System.out.println(sourceMd5Hashcode32+"：原文件32位的md5值");   
